  ...
  await db.insert(subscriptionPackages).values([
    {
      ...
      features: [
        "1 workspace pribadi",
        "Hingga 2 akun keuangan",
        "5 kategori custom",
        "3 rencana anggaran aktif",
    ...
    },
    {
      ...
      features: [
        "2 workspace pribadi",
        "Hingga 5 akun keuangan",
        "Kategori & budget tanpa batas",
        "Penjadwalan tagihan & pengingat",
        "Export laporan ke Excel/CSV",
        "Prioritas support email"
      ],
      maxWorkspaces: 2,
      maxAccounts: 5,
      maxMembers: 1,
      ...
      canCreateSharedWorkspace: false,
      type: "personal",
      description: "Paket premium untuk pengguna personal dengan otomatisasi dan export laporan",
      isActive: true
    },
    {
      name: "professional",
      ...
      price: "35000.00",
      features: [
        "3 workspace (pribadi & tim)",
        "Kolaborasi hingga 2 shared workspace",
        "7 akun keuangan & sinkronisasi realtime",
        "10 anggota kolaborator",
        "Approval workflow & catatan transaksi",
        "Laporan kolaborasi & export",
        "Prioritas support chat"
      ],
      maxWorkspaces: 3,
      maxAccounts: 7,
      maxMembers: 10,
      maxCategories: null,
      maxBudgets: 12,
      maxSharedWorkspaces: 2,
      canCreateSharedWorkspace: true,
      type: "hybrid",
      description: "Paket profesional dengan kolaborasi lintas tim dan workflow persetujuan",
      isActive: true
    },
    {
      name: "business",
      ...
      price: "65000.00",
      features: [
        "7 workspace tim & personal",
        "Hingga 5 shared workspace aktif",
        "15 akun keuangan terhubung",
        "15 anggota tiap workspace",
        "Automasi laporan multi-cabang",
        "Custom role & izin granular",
        "Integrasi API & webhooks",
      ...
      maxCategories: null,
      maxBudgets: null,
      maxSharedWorkspaces: 5,
      canCreateSharedWorkspace: true,
      type: "hybrid",
      description: "Paket business untuk organisasi dengan kebutuhan kontrol penuh dan dukungan dedicated",
      isActive: true
    }
  ]).onConflictDoNothing();
}
...
async function seedSubscriptionPackageLimitScopes() {
  ...
  const scopedLimits: Array<{ slug: string; resource: string; scope: 'per_workspace' | 'global_user'; limit: number | null }> = [
    ...
    { slug: 'basic', resource: 'categories', scope: 'per_workspace', limit: 5 },
    { slug: 'basic', resource: 'budgets', scope: 'per_workspace', limit: 3 },
    { slug: 'premium', resource: 'accounts', scope: 'global_user', limit: 5 },
    { slug: 'premium', resource: 'categories', scope: 'global_user', limit: null },
    { slug: 'premium', resource: 'budgets', scope: 'global_user', limit: null },
    { slug: 'shared-default', resource: 'accounts', scope: 'global_user', limit: 7 },
    { slug: 'shared-default', resource: 'categories', scope: 'global_user', limit: null },
    { slug: 'shared-default', resource: 'budgets', scope: 'global_user', limit: 12 },
    { slug: 'business', resource: 'accounts', scope: 'global_user', limit: 15 },
    { slug: 'business', resource: 'categories', scope: 'global_user', limit: null },
    { slug: 'business', resource: 'budgets', scope: 'global_user', limit: null },
  ];
